                ...
                <table class="table mt-5">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td><a href="../PHP/modificar_alumno.php?id=<?php echo $row['id']?>" class="btn btn-info">Editar</a></td>
                            <td><a href="../PHP/delete_alumno.php?id=<?php echo $row['id']?>" class="btn btn-danger">Borrar</a></td>
                        </tr>
                        </tr>
