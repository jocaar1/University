...
<html lang="en">
  ...
  <body class="fondo">
    ...
    <div class="container mt-5">
                <form action="../PHP/edit_profes.php" method="POST">
                    <input type="hidden"name="id" value="<?php echo $row['Id_profesor']?>">
        
                    <input type="text"class="form-control mb-3" name="id" placeholder="id"value="<?php echo $row['Id_profesor']?>">
                    <input type="text"class="form-control mb-3" name="nombre" placeholder="Nombre"value="<?php echo $row['Nombre_prof']?>">
                    <input type="text"class="form-control mb-3" name="pater" placeholder="Apellido Paterno"value="<?php echo $row['Apellido_Paterno_prof']?>">
                    <input type="text"class="form-control mb-3" name="mater" placeholder="Apellido Materno"value="<?php echo $row['Apellido_Materno_prof']?>">
                    <input type="text"class="form-control mb-3" name="car" placeholder="Carrrera"value="<?php echo $row['Carrera']?>">
