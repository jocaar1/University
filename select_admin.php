<?php
    ...
    $Consultar = "SELECT * FROM administrativos";
            ...
            <li>    <div class="dropdown">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="Administrativos.html">Administrativos</a>
                  <hr>
                  <p>ㅤConsultar</p>
                  <hr>
                ...
                <table class="table mt-5">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td><?php echo $row ['lastname_a']?></td>
                            <td><?php echo $row ['secondlastname_a']?></td>
                            <td><?php echo $row ['id']?></td>
                            <td><a href="../PHP/modificar_admins.php?id=<?php echo $row['id']?>" class="btn btn-info">Editar</a></td>
                            <td><a href="../PHP/delete_admin.php?id=<?php echo $row['id']?>" class="btn btn-danger">Borrar</a></td>
                        </tr>
